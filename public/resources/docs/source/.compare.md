...
[Get Postman Collection](http://localhost:8081/pos/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "http://localhost:8081/pos/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"deleniti","ip_address":"atque"}'
...
```bash
curl -X POST \
    "http://localhost:8081/pos/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"et"}'
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/holidays?location_id=soluta&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=in&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":3,"initial_amount":742282.265660488,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":656.401025,"total_card_slips":11,"total_cheques":3,"closing_note":"ipsum","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 3,
    "initial_amount": 742282.265660488,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 656.401025,
    "total_card_slips": 11,
    "total_cheques": 3,
    "closing_note": "ipsum",
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/contactapi?type=sint" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"harum","prefix":"debitis","first_name":"optio","middle_name":"sapiente","last_name":"quaerat","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"dignissimos","address_line_2":"sit","city":"repudiandae","state":"possimus","country":"eum","zip_code":"in","customer_group_id":"non","contact_id":"temporibus","dob":"2000-06-13","custom_field1":"pariatur","custom_field2":"voluptatem","custom_field3":"nihil","custom_field4":"et","email":"est","shipping_address":"iste","position":"fugiat","opening_balance":0,"source_id":3,"life_stage_id":19,"assigned_to":[]}'
...
let body = {
    ...
    "dob": "2000-06-13",
    "custom_field1": "pariatur",
    "custom_field2": "voluptatem",
    "custom_field3": "nihil",
    "custom_field4": "et",
    "email": "est",
    "shipping_address": "iste",
    "position": "fugiat",
    "opening_balance": 0,
    "source_id": 3,
    "life_stage_id": 19,
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"voluptatum","prefix":"aut","first_name":"voluptas","middle_name":"quis","last_name":"quos","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"quas","address_line_2":"accusantium","city":"voluptas","state":"necessitatibus","country":"aspernatur","zip_code":"eos","customer_group_id":"illo","contact_id":"dicta","dob":"2000-06-13","custom_field1":"quia","custom_field2":"exercitationem","custom_field3":"voluptas","custom_field4":"nobis","email":"suscipit","shipping_address":"voluptas","position":"inventore","opening_balance":10.3,"source_id":5,"life_stage_id":15,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "voluptatum",
    "prefix": "aut",
    "first_name": "voluptas",
    "middle_name": "quis",
    "last_name": "quos",
...
```bash
curl -X POST \
    "http://localhost:8081/pos/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":3,"card_number":"maiores","card_holder_name":"excepturi","card_transaction_number":"voluptate","card_type":"voluptatem","card_month":"maiores","card_year":"repellendus","card_security":"possimus","transaction_no_1":"explicabo","transaction_no_2":"architecto","transaction_no_3":"aperiam","cheque_number":"maxime","bank_account_number":"ipsum","note":"mollitia"}'
...
let body = {
    ...
    "card_month": "maiores",
    "card_year": "repellendus",
    "card_security": "possimus",
    "transaction_no_1": "explicabo",
    "transaction_no_2": "architecto",
    "transaction_no_3": "aperiam",
    "cheque_number": "maxime",
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/expense?location_id=culpa&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=hic&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":12,"final_total":37665.13,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":12,"expense_for":13,"contact_id":13,"additional_notes":"vero","is_refund":0,"is_recurring":0,"recur_interval":11,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"voluptatem","recur_repetitions":20,"payment":[{"amount":453.13,"method":"cash","account_id":1,"card_number":"debitis","card_holder_name":"consectetur","card_transaction_number":"aut","card_type":"saepe","card_month":"ducimus","card_year":"dolorem","card_security":"eos","transaction_no_1":"est","transaction_no_2":"optio","transaction_no_3":"voluptatem","note":"eaque","cheque_number":"quia"}]}'
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "http://localhost:8081/pos/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":0.16722387,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":1,"expense_for":7,"contact_id":11,"additional_notes":"voluptatem","is_recurring":0,"recur_interval":4,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"voluptas","recur_repetitions":10,"payment":[]}'
...
let body = {
    "final_total": 0.16722387,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 1,
    "expense_for": 7,
    "contact_id": 11,
    "additional_notes": "voluptatem",
    "is_recurring": 0,
    "recur_interval": 4,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/expense-refund?location_id=eum&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=suscipit&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/product?brand_id=tenetur&category_id=hic&sub_category_id=vel&location_id=et&selling_price_group=aut&name=veritatis&sku=numquam&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/product"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/product/1?selling_price_group=sapiente" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/product/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/variation/?brand_id=quae&category_id=nemo&sub_category_id=et&not_for_selling=quae&name=laboriosam&sku=et&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/variation/"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/sell?location_id=et&contact_id=est&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=delectus&service_staff_id=magnam&shipping_status=ordered&only_subscriptions=consequatur&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/sell"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":11,"contact_id":17,"transaction_date":"2020-07-22 15:48:29","invoice_no":"et","status":"final","is_quotation":true,"tax_rate_id":15,"discount_amount":10,"discount_type":"fixed","sale_note":"aut","staff_note":"vero","commission_agent":15,"shipping_details":"Express Delivery","shipping_address":"voluptatem","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":8,"pay_term_number":3,"pay_term_type":"months","is_recurring":0,"recur_interval":6,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"ad","recur_repetitions":8,"rp_redeemed":18,"rp_redeemed_amount":13.5,"types_of_service_id":15,"service_custom_field_1":"rerum","service_custom_field_2":"quis","service_custom_field_3":"et","service_custom_field_4":"mollitia","round_off_amount":0.65104705,"table_id":16,"service_staff_id":13,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":16,"note":"sit"}],"payments":[{"amount":453.13,"method":"cash","account_id":13,"card_number":"nemo","card_holder_name":"error","card_transaction_number":"quos","card_type":"ut","card_month":"minus","card_year":"non","card_security":"necessitatibus","transaction_no_1":"modi","transaction_no_2":"dolores","transaction_no_3":"minima","bank_account_number":"cupiditate","note":"rem","cheque_number":"et"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_1": "rerum",
            "service_custom_field_2": "quis",
            "service_custom_field_3": "et",
            "service_custom_field_4": "mollitia",
            "round_off_amount": 0.65104705,
            "table_id": 16,
            "service_staff_id": 13,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_month": "minus",
                    "card_year": "non",
                    "card_security": "necessitatibus",
                    "transaction_no_1": "modi",
                    "transaction_no_2": "dolores",
                    "transaction_no_3": "minima",
                    "bank_account_number": "cupiditate",
                    "note": "rem",
                    "cheque_number": "et"
                }
            ]
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "http://localhost:8081/pos/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":20,"transaction_date":"2020-5-7 15:20:22","status":"final","is_quotation":true,"tax_rate_id":12,"discount_amount":10,"discount_type":"fixed","sale_note":"quos","staff_note":"et","commission_agent":5,"shipping_details":"Express Delivery","shipping_address":"ex","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":11,"pay_term_number":1,"pay_term_type":"months","is_recurring":0,"recur_interval":5,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"et","recur_repetitions":20,"rp_redeemed":17,"rp_redeemed_amount":13.5,"types_of_service_id":16,"service_custom_field_1":"molestiae","service_custom_field_2":"delectus","service_custom_field_3":"nihil","service_custom_field_4":"nam","round_off_amount":542520729.225617,"table_id":18,"service_staff_id":2,"change_return":0,"change_return_id":3,"products":[{"sell_line_id":3,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":4,"discount_amount":0,"discount_type":"percentage","sub_unit_id":2,"note":"perspiciatis"}],"payments":[{"payment_id":16,"amount":453.13,"method":"cash","account_id":11,"card_number":"quibusdam","card_holder_name":"reprehenderit","card_transaction_number":"voluptatem","card_type":"inventore","card_month":"rerum","card_year":"eum","card_security":"ad","transaction_no_1":"consequatur","transaction_no_2":"molestiae","transaction_no_3":"id","note":"deserunt","cheque_number":"consequatur","bank_account_number":"reprehenderit"}]}'
...
let body = {
    ...
    "service_custom_field_2": "delectus",
    "service_custom_field_3": "nihil",
    "service_custom_field_4": "nam",
    "round_off_amount": 542520729.225617,
    "table_id": 18,
    "service_staff_id": 2,
    "change_return": 0,
    "change_return_id": 3,
...
```bash
curl -X DELETE \
    "http://localhost:8081/pos/public/connector/api/sell/consequatur" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "http://localhost:8081/pos/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":1,"transaction_date":"2020-5-7 15:20:22","invoice_no":"dolor","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":16,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "http://localhost:8081/pos/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":18,"shipping_status":"ordered","delivered_to":"recusandae"}'
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/table?location_id=illo" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/taxonomy?type=tempore" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/user/loggedin"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/user?service_staff=nihil" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/user"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "http://localhost:8081/pos/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"est","new_password":"quibusdam"}'
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/profit-loss-report?location_id=sunt&start_date=2018-06-25&end_date=2018-06-25&user_id=consequatur" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "http://localhost:8081/pos/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8081/pos/public/connector/api/notifications"
);
